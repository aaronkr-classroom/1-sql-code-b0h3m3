...
--새 과목 추가하기
CALL InsertOrUpdateCourse('c006', '연극학개론', '310', '교약학부', 2);
SELECT * FROM 과목2;
...
-- MySQL에서만 간단해
-- CALL SelctAverageOfBestScore(95, @Count);
-- SELECT @Count;
...
AFTER INSERT OR 학생2 FOR EACH ROW
