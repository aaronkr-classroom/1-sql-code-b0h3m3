...
CREATE TABLE 학생2 (
	학번 CHAR(4) NOT NULL,
	이름 VARCHAR(20) NOT NULL,
	주소 VARCHAR(50) DEFAULT '미정', -- MySql DEFAULT 가능
	학년 INT NOT NULL,
	나이 INT NULL,
	성별 CHAR(1) NOT NULL,
	휴대폰번호 CHAR(13) NULL,
...
ALTER DATABASE univdb25 OWNER TO supermanager; -- 소유자로 변경하면 모든 권한이 있다
...
CREATE VIEW V2_과목수강현황(과목번호, 강의실, 수강인원수)
	AS SELECT 과목2.과목번호, 강의실, COUNT(과목2.과목번호)
