CREATE TABLE 학원생(
	id bigserial, -- bigserial은 postgres에서만 사용할 수 있는 자동 증가하는 숫자
	학원생이름 varchar(25),
	폰번호 varchar(13),
	나이 int,
	학교이름 varchar(25),
...
CREATE TABLE 학교(
	...
	학교명 varchar(25),
	분류 int,
	학생수 numeric, -- int는 약간 작은 정수이어서 numeric 타입을 사용할게요.
	주소 varchar(100)
);
DROP TABLE 학;
INSERT INTO 학교 (학교명, 분류, 학생수, 주소)
VALUES ('송원고', 3, 435, '경기 성남 분당구 황새울로 123'),
...
REFERENCES 학원생(학교이름) ON DELETE CASCADE;